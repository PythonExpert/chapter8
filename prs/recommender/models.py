...
class CF_Similarity(models.Model):
    ...
    source = models.DecimalField(max_digits=10, decimal_places=0, blank=False, primary_key=True, null=False)
    target = models.DecimalField(max_digits=10, decimal_places=0, blank=False, primary_key=True, null=False)
